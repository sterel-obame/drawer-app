...
const CardItem = ({item}) => {
    ...
    return (
        <Card style={styles.cardStyle}>
            ...
            <Card.Actions>
                <Button onPress={()=>alert('Successfully liked')}>Like</Button>
                <Button onPress={()=>alert('Successfully shared')}>Share</Button>
...
const HomeScreen = ({navigation, route}) => {
    ...
    return (
        <View style={{backgroundColor:Color.skyBlue, paddingBottom:10}}>
            <AppHeader
                title={'Home'}
            ...
            <FlatList
                ...
                // ListHeaderComponent={
                    // j'ai enlevé le composant <AppHeader /> d'ici, c'est dedans là qu'il était
                // }
                renderItem={({item})=>(
                    <CardItem item={item} />
                )}
